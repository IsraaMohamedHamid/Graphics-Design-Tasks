...
void displayFcnAll(void)
{
    /*  Define initial position for Rectangle.  */
    GLint nVerts = 4;
    wcPt2D verts[4] = { {100.0,25.0},{150.0,25.0},{150,100},{100,100} };

    /*  Calculate position of Rectangle centroid.  */
    wcPt2D centroidPt;
    ...
    glColor3f(0.8784, 0.0667, 0.3725);     //  Set initial fill color to blue.
    Rectangle(verts);               //  Display blue Rectangle.
    ...
    /*  Apply composite matrix to Rectangle vertices.  */
    transformVerts2D(nVerts, verts);

    glColor3f(0.0, 0.1922, 0.3216);  // Set color for transformed Rectangle.
    Rectangle(verts);           // Display red transformed Rectangle.

    glFlush();
}

void displayFcnTranslate(void)
{
    /*  Define initial position for Rectangle.  */
    GLint nVerts = 4;
    wcPt2D verts[4] = { {100.0,25.0},{150.0,25.0},{150,100},{100,100} };
    ...
    glColor3f(1.0, 1.0, 0.0);     //  Set initial fill color to blue.
    Rectangle(verts);               //  Display blue Rectangle.
    ...
    glColor3f(1.0, 0.0, 1.0);  // Set color for transformed Rectangle.
    Rectangle(verts);           // Display red transformed Rectangle.

    glFlush();
}

void displayFcnRotate(void)
{
    /*  Define initial position for Rectangle.  */
    GLint nVerts = 4;
    wcPt2D verts[4] = { {100.0,25.0},{150.0,25.0},{150,100},{100,100} };
    ...
    glColor3f(0.0, 1.0, 0.0);  // Set color for transformed Rectangle.
    Rectangle(verts);           // Display red transformed Rectangle.

    glFlush();
}

void displayFcnScale(void)
{
    /*  Define initial position for Rectangle.  */
    GLint nVerts = 4;
    wcPt2D verts[4] = { {100.0,25.0},{150.0,25.0},{150,100},{100,100} };
    ...
    glColor3f(0.0, 0.5, 1.0);      //  Set initial fill color to blue.
    Rectangle(verts);               //  Display blue Rectangle.
    ...
    glColor3f(0.5, 0.0, 0.5);  // Set color for transformed Rectangle.
    Rectangle(verts);           // Display red transformed Rectangle.
...
void main(int argc, char** argv)
{
    ...
    init();
    glutDisplayFunc(displayFcnTranslate);
    glutReshapeFunc(winReshapeFcn);
    ...
    init();
    glutDisplayFunc(displayFcnRotate);
    glutReshapeFunc(winReshapeFcn);
    ...
    init();
    glutDisplayFunc(displayFcnScale);
    glutReshapeFunc(winReshapeFcn);
